;(function () {
  var Surface = function (node) {
    ...
    var displayWidth = 700, displayHeight = 700, zoom = 0.95
    var trans
    ...
    var renderSurface = function () {
      ...
      for (var x = 0; x < xlength - 1; x++) {
        for (var y = 0; y < ylength - 1; y++) {
          ...
          d0.push({
            path:
  'M' + (data[x][y][0] + displayWidth / 2).toFixed(10) + ',' + (data[x][y][1] + displayHeight / 1.25).toFixed(10) +
  'L' + (data[x + 1][y][0] + displayWidth / 2).toFixed(10) + ',' + (data[x + 1][y][1] + displayHeight / 1.25).toFixed(10) +
  'L' + (data[x + 1][y + 1][0] + displayWidth / 2).toFixed(10) + ',' + (data[x + 1][y + 1][1] + displayHeight / 1.25).toFixed(10) +
  'L' + (data[x][y + 1][0] + displayWidth / 2).toFixed(10) + ',' + (data[x][y + 1][1] + displayHeight / 1.25).toFixed(10) + 'Z',
            depth: depth,
